                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <form action="dept/add" method="post" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea id="ddesc" name="ddesc" class="form-control" rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea id="cdesc" name="cdesc" class="form-control" rows="2"></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button class="btn btn-success btn-block dept-submit">添加</button>
                                </div>
                            </div>
                        </div>
                    </div>
